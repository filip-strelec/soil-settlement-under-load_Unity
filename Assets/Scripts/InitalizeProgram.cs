...
public class InitalizeProgram : MonoBehaviour
{
 ...
 private void ShowAxisNumbersNGridMultipleLoads()
    {
 ...
 public void InitializeProgramMultipleLoads()
    {

        double sirinaTemelja = 13;
        ...
        InputField sirinaInputBX = GameObject.Find("InputFieldSirinaX").GetComponent<InputField>();
        InputField duzinaInputLY = GameObject.Find("InputFieldDuzinaY").GetComponent<InputField>();
...
programState.inkrementMjerenjaZ =0;
programState.sirinaB = 22;
programState.duzinaL = 22;

        bool canConvertSirina = double.TryParse(sirinaInputBX.text, out double sirinaKoordSustava);
        programState.sirinaKoordSustavaB = sirinaKoordSustava;

        bool canConvertDuzina = double.TryParse(duzinaInputLY.text, out double duzinaKoordSustava);
        programState.duzinaKoordSustavaL = duzinaKoordSustava;
     ...
     Debug.Log("VAZNO!"+ brojMjerenja);


        if ( programState.dubinaZ != 0 && brojMjerenja != 0 )
        {
...
sirinaBText.text ="B: "+ programState.sirinaB.ToString("0.00");
            ...
            ShowAxisNumbersNGridMultipleLoads();
